          ...
          <div className="card border-light-subtle shadow-sm h-100">
            <div className="login-content row g-0 h-100">
              <div className="left-login h-100">
                <div id="carouselExampleAutoplaying" className="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="2000">
                  ...
                  <div className="carousel-inner h-100">
                    <div className="carousel-item active h-100">
                      <img src={slider1} className="d-block w-100 h-100" alt="Slide 1" />
                    </div>
                    <div className="carousel-item h-100">
                      <img src={slider2} className="d-block w-100 h-100" alt="Slide 2" />
                    </div>
                    <div className="carousel-item h-100">
                      <img src={slider3} className="d-block w-100 h-100" alt="Slide 3" />
                    </div>
                  </div>
